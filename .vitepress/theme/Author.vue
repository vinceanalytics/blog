    ...
    <dd>
      <ul class="flex justify-center xl:block space-x-8 sm:space-x-12 xl:space-x-0 xl:space-y-8">
        <li class="flex items-center space-x-2">
          <img v-if="frontmatter.avatar" :src="frontmatter.avatar" alt="author image" class="w-10 h-10 rounded-full" />
          <dl class="text-sm font-medium leading-5 whitespace-nowrap">
            ...
            <dd v-if="frontmatter.github">
              <a :href="'https://github.com/' + frontmatter.github" target="_blank" rel="noopnener noreferrer"
                class="link">@gernest</a>
            </dd>
          </dl>
        </li>
      </ul>
